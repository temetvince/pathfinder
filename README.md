...
**For installation please see our ~~[Docker-compose solution](https://github.com/goryn-clade/pathfinder-containers)~~ [Docker-compose-solution](https://github.com/temetvince/pathfinder-containers) that includes a detailed guide on how to get up and running.**
